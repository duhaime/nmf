...
class NMF:
  def __init__(self, files=None, encoding='utf8', max_files=None, topics=20, iters=100, words=10, write_output=True):
    self.files = files
  ...
  def get_documents_by_topics(self):
    ...
    return docs_by_topics / np.sum(docs_by_topics, axis=1, keepdims=True)
